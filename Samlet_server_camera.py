...
model = YOLO(r'C:\Users\mathi\Desktop\CDIO.v7-test.yolov8\best.pt')
...
class RobotNavigation:
    ...
    def move_towards_target(self, current_position, target_position, areas, collector_size, step=30):
        route = []
...
def camera_route():
    ...
    filtered_ball_positions = [
        ...
        if not any(RobotNavigation.is_point_in_area(ball[1], area[0], area[1], collector_size[0]) for area in areas)
    ]
